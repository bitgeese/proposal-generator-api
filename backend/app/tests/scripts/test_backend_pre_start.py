...
from app.backend_pre_start import main as backend_main
...
def test_init_successful_connection() -> None:
    ...
    with patch("app.backend_pre_start.Session", return_value=session_mock) as mock_session:
        try:
            init(engine_mock)
...
def test_main_success():
    ...
    with patch("app.backend_pre_start.init", return_value=None) as mock_init:
        backend_main()
